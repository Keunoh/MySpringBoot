...
public class ItemRepositoryTest02 {
    @Autowired // null인 객체를 외부에서 주입(injection)해주는
            // 어노테이션
...
//        this.createItemTestMany();
    ...
    public void queryDslTest01(){
        ...
        // Item Entity에서 판매중인 상품 중에서 상품들을 가격 역순으로 출력
        // like 연산자로 데이터 필터 검색 한다.(달아요 찾기)
    ...
    public void queryDslTest2(){
        // 판매 중인 상품 중에서 단가가 200초과이고, 상품설명에 '어'가 포함되어 있는
        // 상품을 조회하세요. 1페이지에 2개씩 볼거고, 2페이지를 봅니다.
//        select * from item
...
//        and item_detail like '%어%';
        ...
        // 페이징 처리 구간
        // 프로그래밍에선 0베이스임. 아래 1, 2는 사람이 보았을때 2페이지를 의미하며,
        // 2개씩 보여준다는 의미
        Pageable pageable = PageRequest.of(1, 2);

        // findAll 쓸라면 itemRepository 인터페이스에서
        // QuerydslPredicateExecutor<Item> 이거 상속 받으셈
